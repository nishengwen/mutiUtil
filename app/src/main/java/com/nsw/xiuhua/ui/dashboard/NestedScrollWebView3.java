...
public class NestedScrollWebView3 extends WebView implements NestedScrollingChild2 {

    private static final String TAG = NestedScrollWebView3.class.getSimpleName();
    ...
    public NestedScrollWebView3(Context context) {
        this(context, null);
    }

    public NestedScrollWebView3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollWebView3(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(initialVelocity) > mMinimumVelocity) {
                    Log.d(TAG+"fling", "onTouchEvent 滑动:initialVelocity"+initialVelocity+" mMinimumVelocity:"+mMinimumVelocity);
                    fling(-initialVelocity);
                }else{
                    Log.d(TAG+"fling", "onTouchEvent 不滑动:initialVelocity"+initialVelocity+" mMinimumVelocity:"+mMinimumVelocity);
                }
